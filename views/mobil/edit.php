...
<head>
    ...
    <title>Edit Mobil - CarPoint</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong><i class="fa fa-edit"></i> Form Edit Mobil</strong>
                        </div>
                        <div class="card-body">
                            <form action="<?= base_url('index.php?page=mobil/update') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="plat" class="form-control" value="<?= $mobil->plat ?>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" required>
                                                ...
                                                <option value="dipesan" <?= $mobil->status == 'dipesan' ? 'selected' : '' ?>>Dipesan</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><i class="fa fa-image"></i> Ganti Foto</label>
                                ...
                                <!-- Preview Foto Lama -->
                                <?php if ($mobil->foto && file_exists($mobil->foto)): ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><i class="fa fa-image"></i> Foto Saat Ini</label><br>
                                            <img src="<?= base_url($mobil->foto) ?>" class="preview-img">
                                        </div>
                                    </div>
                                </div>
                                <?php endif; ?>
